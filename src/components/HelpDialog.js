    ...
    return (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
            <div className="bg-slate-900 text-white p-6 rounded-lg max-w-lg max-h-[80vh] overflow-y-auto shadow-lg">
                ...
                <p className="mb-2">
                    This is Conway's Game of Life grid, where you can interact with cells, patterns, and configurations.
                </p>
                <ul className="ml-4 list-disc text-left list-outside mb-4">
                    <li>
                        <strong>Toggle Cells:</strong> Click on the grid to turn cells on (black) or off (empty).
                    </li>
                    <li>
