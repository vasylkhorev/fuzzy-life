...
const translations = {
    en: {
        ...
        weightEditor: {
            ...
            birthRulesHelp: 'Allowed weighted sums for birth (e.g. 2, 3 or 2.5-4)',
            survivalRules: 'Survival Rules',
            survivalRulesHelp: 'Allowed weighted sums for survival (e.g. 2, 4 or 2-4.5)',
            ...
            info3: 'Birth: dead cell becomes alive if weighted sum matches rules (range or set)',
            info4: 'Survival: live cell stays alive if weighted sum matches rules (range or set)',
    ...
    sk: {
        ...
        weightEditor: {
            ...
            birthRulesHelp: 'Povolené vážené súčty pre zrod (napr. 2, 3 alebo 2.5-4)',
            survivalRules: 'Pravidlá prežitia',
            survivalRulesHelp: 'Povolené vážené súčty pre prežitie (napr. 2, 4 alebo 2-4.5)',
            ...
            info3: 'Zrod: mŕtva bunka ožije, ak vážený súčet odpovedá pravidlám (rozsah alebo meno)',
            info4: 'Prežitie: živá bunka prežije, ak vážený súčet odpovedá pravidlám (rozsah alebo meno)',
